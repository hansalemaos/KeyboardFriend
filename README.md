...
- Add keyboard abbreviations to make your life easier
- App accepts comma separated txt file
- Huge **Portuguese-German** vocabulary list included
- No coding required!
...
| -------------------------------------------------------------- |- |
Create a comma separated list|<img src="33_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Start the app and select the list|<img src="66_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Choose a prefix, I usually use "@"|<img src="99_800x800.png" width="400"/> |
...
| -------------------------------------------------------------- |- |
The text will change to "übrigens".|<img src="198_800x800.png" width="400"/> |
